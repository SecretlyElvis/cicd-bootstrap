...
# ALB Ingress:  ALL ports from Fargate (ECS Issues Commands to ALB)
resource "aws_vpc_security_group_ingress_rule" "alb-ingress-ecs" {
...
# ECS Egress - ALL Protocols to ALB SG (ECS Issues Commands to ALB)
resource "aws_vpc_security_group_egress_rule" "ecs-egress-alb" {
